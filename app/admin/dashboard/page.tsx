    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Torre de Controle</h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-10">
                {stats.map((stat, i) => (
                    <div key={i} className="bg-slate-900/40 border border-slate-800 p-4 sm:p-6 rounded-2xl hover:bg-slate-900/60 transition-all group">
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
                <div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900/20">
                    <h2 className="text-lg sm:text-xl font-bold text-white">Últimas Atualizações</h2>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-950/50">
                                ...
                                <th className="px-4 sm:px-8 py-4 sm:py-5 text-slate-500 text-xs font-bold uppercase tracking-wider">Pendências</th>
                                <th className="px-4 sm:px-8 py-4 sm:py-5 text-center text-slate-500 text-xs font-bold uppercase tracking-wider hidden sm:table-cell">Status Geral</th>
                                <th className="px-2 sm:px-8 py-4 sm:py-5"></th>
                            </tr>
                        </thead>
                        <tbody>
