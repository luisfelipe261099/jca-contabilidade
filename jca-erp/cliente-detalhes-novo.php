...
<div class="p-6 space-y-6">
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    $statusColor = $statusColors[$cliente['status']] ?? 'bg-gray-500';
                    ?>
            ...
            <div class="flex flex-col gap-2">
                <a href="cliente-centro-controle.php?id=<?php echo $clienteId; ?>" class="px-6 py-3 bg-white text-primary-700 rounded-lg hover:bg-primary-50 transition-all shadow-md hover:shadow-lg font-semibold flex items-center gap-2">
                    <i data-lucide="layout-dashboard" class="w-5 h-5"></i>
                    Centro de Controle
                </a>
                <div class="flex gap-2">
                    <a href="cliente-editar.php?id=<?php echo $clienteId; ?>" class="px-4 py-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-lg transition-colors flex items-center gap-2">
                        <i data-lucide="edit" class="w-4 h-4"></i>
                        Editar
                    </a>
                    <a href="clientes.php" class="px-4 py-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-lg transition-colors flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <a href="cliente-funcionarios.php?id=<?php echo $clienteId; ?>" class="bg-white rounded-lg border-2 border-blue-200 p-6 hover:border-blue-400 hover:shadow-lg transition-all">
        ...
        <a href="tarefas.php?cliente_id=<?php echo $clienteId; ?>" class="bg-white rounded-lg border-2 border-amber-200 p-6 hover:border-amber-400 hover:shadow-lg transition-all">
            <div class="flex items-center gap-4">
        ...
        <a href="cliente-certificados.php?cliente_id=<?php echo $clienteId; ?>" class="bg-white rounded-lg border-2 border-green-200 p-6 hover:border-green-400 hover:shadow-lg transition-all">
            <div class="flex items-center gap-4">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <p class="font-medium text-gray-900">
                        <?php echo htmlspecialchars($cliente['endereco']); ?>, <?php echo htmlspecialchars($cliente['numero']); ?>
                        <?php if ($cliente['complemento']): ?> - <?php echo htmlspecialchars($cliente['complemento']); ?><?php endif; ?>
                    </p>
                    <p class="text-gray-700">
                        <?php echo htmlspecialchars($cliente['bairro']); ?> - <?php echo htmlspecialchars($cliente['cidade']); ?>/<?php echo htmlspecialchars($cliente['estado']); ?>
                    </p>
        ...
        <div class="bg-white rounded-lg border border-gray-200">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo htmlspecialchars($cliente['telefone']) ?: '-'; ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 mb-1">Celular</p>
                    <p class="font-semibold text-gray-900"><?php echo htmlspecialchars($cliente['celular']) ?: '-'; ?></p>
                </div>
                <div>
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <p class="font-semibold text-gray-900"><?php echo htmlspecialchars($cliente['responsavel_nome']) ?: '-'; ?></p>
                    ...
                    <?php if ($cliente['responsavel_telefone']): ?>
                        <p class="text-sm text-gray-700"><?php echo htmlspecialchars($cliente['responsavel_telefone']); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200">
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Malha Fiscal</p>
                        <p class="font-semibold text-gray-900"><?php echo $cliente['malha_fiscal']; ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Abertura/Fechamento</p>
                        <p class="font-semibold text-gray-900"><?php echo $cliente['abertura_fechamento'] ?: '-'; ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo htmlspecialchars($cliente['contador_nome']) ?: '-'; ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Valor Mensalidade</p>
                        <p class="font-semibold text-gray-900"><?php echo formatarMoeda($cliente['valor_mensalidade']); ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        $statusColor = $statusColors[$cliente['status']] ?? 'bg-gray-100 text-gray-700';
                        ?>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                <a href="tarefa-nova.php?cliente_id=<?php echo $clienteId; ?>" class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-primary-400 hover:shadow-md transition-all">
                ...
                <a href="cliente-funcionario-novo.php?cliente_id=<?php echo $clienteId; ?>" class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-green-400 hover:shadow-md transition-all">
                ...
                <a href="cliente-certificado-novo.php?cliente_id=<?php echo $clienteId; ?>" class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-amber-400 hover:shadow-md transition-all">
...
<?php include 'includes/footer.php'; ?>
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo formatarData($cliente['data_cadastro']); ?></p>
                    </div>
                </div>
