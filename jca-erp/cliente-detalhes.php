                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <?php if ($cliente['logradouro']): ?>
                        <p class="font-medium text-gray-900">
                            <?php echo htmlspecialchars($cliente['logradouro']); ?>, <?php echo htmlspecialchars($cliente['numero'] ?? 'S/N'); ?>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo $cliente['data_abertura'] ? formatarData($cliente['data_abertura']) : '-'; ?></p>
                    </div>
                    <div>
